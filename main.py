...
def upsert_pr_comment(pr_data: dict, message: str):
    ...
    signature = "*This comment was generated by AI. Please review and update as needed.*"
    ...
    ai_comment = next((c for c in existing_comments if c["user"]["login"] == os.getenv("GITHUB_ACTOR") and c["body"].strip().endswith(signature)), None)
